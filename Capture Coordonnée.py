...
fenetre.iconbitmap('icone/icone.ico') # Remplacez par le chemin vers votre fichier .ico
...
def about():
    ...
    github_link = tk.Label(frame, text="Lien GitHub : https://github.com/your-repo", fg="blue", cursor="hand2")
    github_link.pack()
